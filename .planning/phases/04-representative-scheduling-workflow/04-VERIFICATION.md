...
- Completed runs expose request-to-sync lineage through a final summary artifact populated from persisted approval and sync records, and that final summary now refreshes when replay adds new downstream lineage after completion. See [workflow_service.py](/Users/ankush/git/helm/packages/orchestration/src/helm_orchestration/workflow_service.py#L668), [workflow_service.py](/Users/ankush/git/helm/packages/orchestration/src/helm_orchestration/workflow_service.py#L1439), and [test_replay_service.py](/Users/ankush/git/helm/tests/unit/test_replay_service.py#L272).
- Automated verification covers creation, approval pause semantics, revision lineage, approved writes, completion summary projection, replay/recovery, restart-safe resume, and a public-entrypoint representative lifecycle that starts through `/v1/workflow-runs`, runs real worker specialist dispatch, completes approved sync, and then requests replay. See [test_workflow_status_service.py](/Users/ankush/git/helm/tests/unit/test_workflow_status_service.py#L304), [test_workflow_orchestration_service.py](/Users/ankush/git/helm/tests/unit/test_workflow_orchestration_service.py#L1311), [test_workflow_status_routes.py](/Users/ankush/git/helm/tests/integration/test_workflow_status_routes.py#L292), and [workflow-runs.md](/Users/ankush/git/helm/docs/runbooks/workflow-runs.md#L78).

Requirement cross-reference:

- Plan frontmatter for `04-01` and `04-02` targets `DEMO-01`, `DEMO-04`, `DEMO-05`, and `DEMO-06`.
- The implementation and passing tests satisfy those behaviors.
- `.planning/REQUIREMENTS.md` marks those four requirements complete, and the phase summaries and verification evidence now agree with that traceability state.
