...
def test_inbound_transition_routes_low_confidence_surface_to_needs_review() -> None:
    update = transition_for_inbound(
        classification="unclassified",
        priority_score=2,
        thread_summary="Potentially important but ambiguous",
        should_surface=True,
        action_item_required=True,
    ...
    assert update.latest_confidence_band == "Low"
    assert update.action_reason == "classification_uncertain"
